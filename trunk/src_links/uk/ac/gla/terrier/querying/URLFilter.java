...
public class URLFilter implements PostFilter
{
	...
	{
		String url = "http://" + rs.getMetaItem("url", DocAtNumber);
		if(! url.toLowerCase().startsWith(urlFilter))
