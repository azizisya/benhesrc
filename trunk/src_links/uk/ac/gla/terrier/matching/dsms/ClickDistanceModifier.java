...
queryid docno docno docno
  ...
  */
public class ClickDistanceModifier implements DocumentScoreModifier
{
	protected double w;
	protected double k;
	protected double a;
	...
	public ClickDistanceModifier()
	{
		...
		try{
			...
			final BufferedReader br = Files.openFileReader(
				ApplicationSetup.getProperty("ClickDistanceModifier.inputfile", null));
			String line = null;
