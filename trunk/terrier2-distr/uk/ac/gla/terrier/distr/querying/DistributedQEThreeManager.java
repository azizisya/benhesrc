 ...
 * under the License.
 *
 * The Original Code is DistributedQEThreeManager.java.
 *
 ...
 */
public class DistributedQEThreeManager extends DistributedThreeManager{
	/**
	 * The DistributedThreeManager that corresponds to the local collection.
	 */
	DistributedThreeManager queryingManager;
	/**
	 ...
	 */
	public DistributedQEThreeManager (){
		this.loadQELexicon();
		this.loadQEServers();
	}
	...
	public void runPostProcessing(SearchRequest srq)
	{
		...
		//System.out.println("result size: "+rq.getResultSet().getResultSize());
		//double[] scores = rq.getResultSet().getScores();
...
//	public double getKLDivergence(String[] terms){
//		double KLDivSum = 0;
//		for (int i=0; i<terms.length; i++)
//			KLDivSum += getKLDivergence(terms[i]);
//		return KLDivSum;
//	}
	
//	public double getKLDivergence(String term){
//		return Statistics.KLDivergence(getCollectionModel(term), 
//				queryingManager.getCollectionModel(term));
//	}
...
//					}
//					catch(RemoteException e){
//						System.err.println("remote exception occurs while " +
