 ...
 * under the License.
 *
 * The Original Code is DistributedFieldTRECQuerying.java.
 *
...
import uk.ac.gla.terrier.applications.FieldTRECQuerying;
 ...
 */
public class DistributedFieldTRECQuerying extends FieldTRECQuerying {
	/**
	 * The default constructor.
	 *
	 */
	public DistributedFieldTRECQuerying (){
	}
	...
	public static void main(String[] args){
		...
		//accross the servers
		DistributedFieldTRECQuerying querying = new DistributedFieldTRECQuerying();
		if (args.length!=0){
			// create the global lexicon
			if (args[0].equalsIgnoreCase("-r"))
				((DistributedFieldManager)querying.queryingManager).rebuildLexicon();
		}
		else
