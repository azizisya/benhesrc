...
public abstract class TermSelector {
	...
	* expanded terms.
	...
	public abstract void assignTermWeights(ResultSet resultSet, int feedbackSetSize, QueryExpansionModel QEModel, Lexicon bgLexicon);
	
	
	public abstract void assignTermWeights(int[] docids, QueryExpansionModel QEModel, Lexicon bgLexicon);
	
	public abstract void assignTermWeights(TIntIntHashMap[] termidFreqMap, QueryExpansionModel QEModel, 
