...
public class Manager
{
	...
	protected Hashtable<String, Matching> Cache_Matching = new Hashtable<String, Matching>();
	/** Cache loaded Weighting models in this hashtable */
	protected Hashtable<String, Model> Cache_Weighting = new Hashtable<String, Model>();
	/** Cache loaded PostProcess models in this hashtable */
	protected Hashtable<String, PostProcess> Cache_PostProcess = new Hashtable<String, PostProcess>();
	/** Cache loaded PostFitler models in this hashtable */
	protected Hashtable<String, PostFilter> Cache_PostFilter = new Hashtable<String, PostFilter>();
	/* ------------------------------------------------*/
	...
	protected HashSet<String> Allowed_Controls;
	...
	protected Hashtable<String, String> Default_Controls;
	...
	protected void load_controls_default()
	{
		...
		Default_Controls = new Hashtable<String, String>();
		for(int i=0;i<controls.length;i++)
		{
	...
	protected Matching getMatchingModel(String ModelName)
	{
		...
		rtr = Cache_Matching.get(ModelName);
		if (rtr == null)
		{
			boolean first = true;
	...
	protected Model getWeightingModel(String ModelName)
	{
		...
		else if (ModelName.startsWith("uk.ac.gla.terrier"))
			ModelName = ModelName.replaceAll("uk.ac.gla.terrier", "org.terrier");
		
		//check for already instantiated model
		rtr = Cache_Weighting.get(ModelName);
		if (rtr == null)
		{
			try
			{
