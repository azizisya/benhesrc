...
public class TRECSetup {
	...
	public static void main(java.lang.String[] args) {
		...
		try {	
			...
			propertiesWriter.println("querying.default.controls=start:0,end:999");
			propertiesWriter.println("querying.allowed.controls=c,scope,qe,qemodel,start,end,site,scope");
			propertiesWriter.println();
