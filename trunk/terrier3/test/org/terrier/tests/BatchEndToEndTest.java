...
public abstract class BatchEndToEndTest extends ApplicationSetupBasedTest {
	...
	protected int doRetrieval(String[] topicSet, String[] trecTerrierArgs) throws Exception
	{
		...
		int queryCount = 0;
		for(String topicFile : joinSets(topicSet, retrievalTopicSets))
		{	
		...
		String[] newArgs = new String[1+trecTerrierArgs.length];
		newArgs[0] = "-r";
		System.arraycopy(trecTerrierArgs, 0, newArgs, 1, trecTerrierArgs.length);
