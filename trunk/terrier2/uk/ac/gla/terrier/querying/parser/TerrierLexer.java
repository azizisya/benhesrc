...
tryAgain:
	for (;;) {
		...
		try {   // for char stream error handling
			try {   // for lexical error handling
				...
				case '[':
				{
					mOPEN_SQUARE_PAREN(true);
					theRetToken=_returnToken;
					break;
				}
				case ']':
				{
					mCLOSE_SQUARE_PAREN(true);
					theRetToken=_returnToken;
					break;
				}
				case '~':
	...
	public final void mOPEN_SQUARE_PAREN(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = OPEN_SQUARE_PAREN;
		int _saveIndex;
	...
	public final void mCLOSE_SQUARE_PAREN(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = CLOSE_SQUARE_PAREN;
		int _saveIndex;
