...
/** 
 * This class implements the DH model for query expansion. 
 * See G. Amati's Phd Thesis.
 * @author Gianni Amati, Ben He
 * @version $Revision: 1.1 $
 */
public class DH extends QueryExpansionModel {
	...
	public final double score(
		...
		return withinDocumentFrequency*
			Math.log ((withinDocumentFrequency* averageDocumentLength/totalDocumentLength) *( numberOfDocuments/termFrequency) )
			/Math.log(2)
		   + 0.5d* Math.log(2d*Math.PI*withinDocumentFrequency*(1d-f))/Math.log(2);
	}
	/**
	 * This method implements the query expansion model.
	 * @param withinDocumentFrequency double The term frequency 
