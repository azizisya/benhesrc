...
public class FileRunIteratorFactory extends RunIteratorFactory {
	...
	String[][] files;
	public FileRunIteratorFactory(String[][] _files, Class <? extends PostingInRun> _postingClass)
	{
		files = _files;
	...
	{
		return new FileRunIterator<PostingInRun>(files[runNumber][0], files[runNumber][1], runNumber, postingClass);
	}
