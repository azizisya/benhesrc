...
/* Some optimisation changes by Craig Macdonald:
 *  -> stripPrefixes: optimised by making variables final
 *  -> final variables where possible
 *  -> dont so String += - use a StringBuffer
 */
...
****************************************/
public class PaiceHuskEnglishStemmer implements TermPipeline 
{
...
private	String filerules;
	...
	protected /*final*/ TermPipeline next = null;	
	/**
	 ...
	 *		the term pipeline.
	 */
	public PaiceHuskEnglishStemmer(TermPipeline next)
	{
		this.next = next;
	}
	...
	public void processTerm(String t)
	{
		if (t == null)
			return;
		next.processTerm(stripAffixes(t));
	}
	...
	*Purpose:	init		*
	********************************/
	public PaiceHuskEnglishStemmer(String rules, String pre)
	{
		...
		try
		{
			...
			try
			{
				while ((line=br.readLine())!= null)
				{
					...
					final StringBuffer rule = new StringBuffer(lineLength);
	...
	*			removal can comence		*
	********************************************************/
	private String stripPrefixes (final String str)
	{
		String[] prefixes = { 	
			"kilo"  ,
			"micro" ,
		...
		//not worth keeping a variable for str.length() as it'll probably only be called once
	...
	********************************************************/
	private String Clean( String str )
	{
    	...
    	StringBuffer temp = new StringBuffer(last);
		for ( int i=0; i < last; i++ )
		{
	...
	********************************************************/
	...
	{
		PaiceHuskEnglishStemmer p = new PaiceHuskEnglishStemmer(args[2],args[3]);
		String text;
