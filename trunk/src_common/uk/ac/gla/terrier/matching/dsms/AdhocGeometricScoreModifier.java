 ...
 * @deprecated
 */
public class AdhocGeometricScoreModifier extends GeometricScoreModifier {
	/** The logger used */
	private static Logger logger = Logger.getRootLogger();
	
	public Object clone()
	{
		return new AdhocGeometricScoreModifier(phraseTerms);
	}

	public AdhocGeometricScoreModifier() { } 
	public AdhocGeometricScoreModifier(final String[] pTerms) {
		phraseTerms = pTerms;
	}

	public AdhocGeometricScoreModifier(final String[] pTerms, boolean r) {
		this(pTerms);
	}
