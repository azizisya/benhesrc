 ...
 */
package uk.ac.gla.terrier.smooth.normalisationeffect;
 ...
 * effect for the normalisation B.
 *   Creation date: (15/06/2003 17:21:24)
 *   @author: Ben He
 */
public class NEB extends NormalisationEffect  {    
	/** The normalisation B. */
	protected NormalisationB method = new NormalisationB();
	/**
     ...
     * @param b double The free parameter of the normalisation method.
	...
	public final double getNED(
        double[] documentLength, double b, int definition
    ){
		method.setParameter(b);
