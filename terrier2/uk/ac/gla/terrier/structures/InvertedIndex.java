...
public class InvertedIndex implements LegacyBitFileStructure, Closeable {
	...
	public int[][] getDocumentsForModifiers(LexiconEntry lEntry){
		if (lEntry==null)
			return null;
		return getDocumentsForModifiers(lEntry.startOffset, 
	...
	public int[][] getDocuments(LexiconEntry lEntry, int[] flag){
		if (lEntry==null)
			return null;
		return getDocumentsForModifiers(lEntry.startOffset, 
			lEntry.startBitOffset, 
	...
	public int[][] getDocuments(int termid, boolean[] flag) {
		...
		return getDocuments(lEntry.startOffset,
			lEntry.startBitOffset,
			lEntry.endOffset,
			lEntry.endBitOffset, lEntry.n_t, flag);
	}
	
	public int[][] getDocuments(final long startOffset, final byte startBitOffset, final long endOffset, 
			final byte endBitOffset, final int df, final boolean[] flag){
		return null;
	}
	...
	public int[][] getDocumentsForModifiers(int termid) {
		 LexiconEntry lEntry = lexicon.getLexiconEntry(termid);
		if (lEntry == null)
			return null;
		return getDocumentsForModifiers(lEntry.startOffset,
