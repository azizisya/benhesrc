 ...
 * under the License.
 *
 * The Original Code is MatrixIndex.java.
 *
...
public class MatrixIndex {
    ...
    protected MatrixIndex(long a, long b, long c) { }
	
	/** A default constructor, only for use by child classes */
	protected MatrixIndex() { }
	 ...
	 */
	public MatrixIndex(DocumentIndex docIndex, String filename) {
	...
	public int[][] getTerms(int docid) {
		try {
			...
			final boolean loadTagInformation = true;
			final int fieldTags = 1;
			...
			logger.fatal(
				...
				"a given document. Stack trace follows.",ioe);
