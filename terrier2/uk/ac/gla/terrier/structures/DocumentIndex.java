...
public class DocumentIndex implements Closeable, IndexConfigurable
{
	...
	public int DOCNO_BYTE_LENGTH = ApplicationSetup.DOCNO_BYTE_LENGTH;
	
	protected boolean LOAD_DOCNOS = Boolean.parseBoolean(ApplicationSetup.getProperty("load.docnos", "false"));
