// $ANTLR : "terrier_normallex_hyphen.g" -> "TerrierLexerWithHyphen.java"$
...
public class TerrierLexerWithHyphen extends antlr.CharScanner implements MainTokenTypes, TokenStream
 {
public TerrierLexerWithHyphen(InputStream in) {
	this(new ByteBuffer(in));
}
public TerrierLexerWithHyphen(Reader in) {
	this(new CharBuffer(in));
}
public TerrierLexerWithHyphen(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public TerrierLexerWithHyphen(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	private static final long[] mk_tokenSet_1() {
		...
		data[0]=-576261757878665224L;
		data[1]=-5188146763348836351L;
		return data;
	}
