...
/**
 * This class implements the PC2 weighting model.
 * P stands for Poisson approximation for randomness.
 * C stands for the log of Laplace succession for normalising term weight.
 * 2 stands for Normalisation for term frequency normalisation.
 * @author Gianni Amati, Ben He, Vassilis Plachouras
 * @version $Revision: 1.1 $
 */
public class PC2 extends WeightingModel {
	/** 
	...
	/**
	 * Uses PC2 to compute a weight for a term in a document.
	 ...
	 * @return the score assigned by the weighting model PC2.
	 */
