 ...
 * under the License.
 *
 * The Original Code is In_expL2.java.
 *
...
/**
 * This class implements the In_expL2 weighting model.
 * In stands for inverse expected document frequency model for randomness.
 ...
 */
public class In_expL2 extends WeightingModel {
	/** 
	...
	/**
	* This method computes term weight using In_expL2.
	...
	*/
	public final double weight(
		...
		double f = this.termFrequency / numberOfDocuments;
		double n_exp = numberOfDocuments * (1 - Math.exp(-f));
		return TF * i.idf(n_exp + 0.5d) * NORM;
	}
}
