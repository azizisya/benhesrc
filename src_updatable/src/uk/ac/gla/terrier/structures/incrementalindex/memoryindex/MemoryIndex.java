...
import uk.ac.gla.terrier.structures.incrementalindex.SegmentedDirectIndex;
import uk.ac.gla.terrier.structures.incrementalindex.SegmentedInvertedIndex;
...
import uk.ac.gla.terrier.structures.incrementalindex.memoryindex.MemoryInvertedIndex.postingList;
...
public class MemoryIndex extends Index{
	...
	public void indexDocument(final String docno, final Document doc)
	{
		numberOfDocuments++; 
