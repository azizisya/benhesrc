 ...
 *
 */
public class DocIdFeature extends DocumentFeature {
	 ...
	 * @param index
	 */
	public DocIdFeature(Index index) {
		super(index);
	...
	public void extractDocumentFeature(int docid, String queryid,
		...
		if (CACHED){
			...
			featureMap.put(featureId, docid);
		}
	}
	...
	public static void main(String[] args){
		...
		if (args[0].equals("--preprocess")){
			...
			DocIdFeature app = new DocIdFeature(Index.createIndex(indexpath, indexprefix));
