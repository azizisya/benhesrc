 ...
 */
public class Normalisation2 extends TermFrequencyNormalisation {
	
	protected Idf idf;

    /** A default constructor.*/
    public Normalisation2(CollectionStatistics _collSta) {
    	super(_collSta);
        idf = new Idf(
	...
	public final double getNormalisedTermFrequency(
        ...
        return termFrequency * idf.log(1.0d + (c * averageDocumentLength) / documentLength);
    }
