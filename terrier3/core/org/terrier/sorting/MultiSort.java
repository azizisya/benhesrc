...
public class MultiSort {
	 ...
	 */
	private static final int buildMaxHeap(double[] A, int[] B, short[] C) {
	...
	private static final int buildMaxHeap(int[] A, double[] B, short[] C) {
		final int heapSize = A.length;
		for (int i = heapSize/2; i > 0; i--)
			maxHeapify(A, B, C, i, heapSize);
		return heapSize;
	 ...
	 */
	private static final void reverse(final double[] A, final int[] B, final short[] C, final int topElements) {
	 ...
	 */
	private static final void maxHeapify(final double[] A, final int[] B, final short[] C, final int i, final int heapSize) {
		final int l = 2 * i;
		final int r = 2 * i + 1;
	...
	private static final void maxHeapify(final int[] A, final double[] B, final short[] C, final int i, final int heapSize) {
		final int l = 2 * i;
		final int r = 2 * i + 1;
