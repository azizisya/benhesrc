...
public class DFRBagExpansionTerms extends ExpansionTerms {
	...
	* @param directIndex DirectIndex to use for finding terms for documents
	* @param documentIndex DocumentIndex to use for finding statistics about documents
 	*/
	public DFRBagExpansionTerms(CollectionStatistics collStats, Lexicon<String> lexicon, PostingIndex<BitIndexPointer> directIndex, DocumentIndex documentIndex) {
