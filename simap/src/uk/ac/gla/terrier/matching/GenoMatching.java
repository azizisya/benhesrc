 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class GenoMatching extends Matching {
	
	protected final int max_matching_TF = Integer.parseInt(ApplicationSetup.getProperty("max.matching.TF", "300000"));
	 ...
	 * @param index
	 */
	public GenoMatching(Index index) {
		super(index);
		// TODO Auto-generated constructor stub
	}
	...
	public void match(String queryNumber, MatchingQueryTerms queryTerms) {
		...
		for (int i = 0; i < queryLength; i++) {
			...
			if (IGNORE_LOW_IDF_TERMS && docIndex.getNumberOfDocuments() < lEntry.TF || 
					max_matching_TF >0 && lEntry.TF > max_matching_TF) {
