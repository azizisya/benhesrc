...
public class CollectionFactory
{
	...
	public static Collection loadCollections(final String[] collNames, Class[] contructorTypes, Object[] constructorValues)
		...
		try{
			Class collectionClass = Class.forName(firstCollectionName);
			rtr = (Collection) collectionClass.getConstructor(contructorTypes).newInstance(constructorValues); //collectionClass.newInstance();
