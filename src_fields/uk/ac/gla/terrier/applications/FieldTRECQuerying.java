 ...
 *
 */
public class FieldTRECQuerying extends TRECQuerying {
	/** the logger for this class */
	protected static Logger logger = Logger.getLogger("field");
	protected Index[] indices;
	protected int NumFields;
	public FieldTRECQuerying() {
		//long startLoading = System.currentTimeMillis();
		//this.loadIndex();
		//this.createManager();
		//long endLoading = System.currentTimeMillis();
		mModel = ApplicationSetup.getProperty("matching.model", "uk.ac.gla.terrier.matching.FieldMatching");
	...
	protected void createManager(){
		queryingManager = new FieldManager(indices);
	}
	...
	public static void main(String[] args) {
		...
		timer.start();
		FieldTRECQuerying trecQuerying = new FieldTRECQuerying();
