...
SRC_FILES=`find $HOME/terrier2-distr_local/* -name *.java`
SRC=`echo $SRC_FILES`

CLASSPATH=$LIB/terrier2.jar:$LIB/terrier-fields.jar:$HOME/terrier2-distr_local:$LIB/trove.jar:$LIB/terrier-links-0.2dev.jar:$LIB/antlr-2.7.4.jar:$LIB/smooth.jar:$LIB/stat.jar:$LIB/log4j-1.2.9.jar
...
$JAVAJAR -cf $LIB/terrier2-distr_local.jar -C bin .
rm -r bin
